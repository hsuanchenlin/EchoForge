...
///
/// Identity is the whole point. Four keys reach one `AudioRecorder` - the two
/// dictation keys, ⌥A and ⌥S - and a caller that believes it is recording can be
...
/// This is the entire ownership rule the app's four recording entry points rest
