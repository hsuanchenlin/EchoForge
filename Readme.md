...
- ▶️ Open a channel's latest YouTube video by voice - allowlist channels by their canonical channel ID in Settings, then say "open the latest YouTube video from Veritasium" / "打開YouTube最新影片…" to open its newest video in a new Chrome tab. It can reach only the channels you listed, and the one request it makes is that channel's public feed - no account, no cookies, nothing of yours sent. Part of spoken commands, so off until those are on ([details](docs/youtube-latest-video.md))
