...
- ⚡ Live transcription - with it on, each phrase is transcribed while you are still speaking: the words appear on the capsule as you go, and the paste is ready almost as soon as you stop. Nothing is pasted early and nothing changes about the result - the same engines, dictionary, script and rewriting, one paste at the end - and if anything on the live path fails the recording is transcribed whole as before. Local engines only. Off by default in this release ([details](docs/live-dictation.md))
